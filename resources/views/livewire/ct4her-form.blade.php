                    ...
                    <div class="personal_info">
                        ...
                        <div class="row_entry">
                            <div>
                                ...
                                <input type="text" name="facility_name" id="facility_name" wire:model="facility_name" >
                                <span class="text-danger">@error('facility_name'){{ $message }}@enderror</span>
                            </div>
                            <div>
                                <label for="facility_email_address">Email Address</label><br>
                                <input type="text" name="facility_email_address" id="facility_email_address"  wire:model="facility_email_address">
                        ...
                        <div class="row_entry">
                            <div>
                                ...
                                <input type="text" name="facility_contact_person" id="facility_contact_person"  wire:model="facility_contact_person">
                            ...
                            <div>
                                ...
                                <input type="text" name="facility_contact_person_phone" id="facility_contact_person_phone"  wire:model="facility_contact_person_phone">
                        ...
                        <div class="row_entry">
                            <div>
                                ...
                                <input type="text" name="facility_contact_person_email_address" id="facility_contact_person_email_address"  wire:model="facility_contact_person_email_address">
                                <span class="text-danger">@error('facility_contact_person_email_address'){{ $message }}@enderror</span>
                            </div>
                            <div>
                                <p>Facility Type </p>
                                <input type="radio" id="facility_type_hospital" name="facility_type" value="Hospital"  wire:model="facility_type">
                                <label for="facility_type_hospital">Hospital</label>&nbsp&nbsp&nbsp
                                <input type="radio" id="facility_type_clinic" name="facility_type" value="Clinic"  wire:model="facility_type">
                                <label for="facility_type_clinic">Clinic</label>
                                <input type="radio" id="facility_type_diagnostic_enter" name="facility_type" value="Diagnostic Center"  wire:model="facility_type">
                                <label for="facility_type_diagnostic_enter">Diagnostic Center</label>&nbsp&nbsp&nbsp
                                <input type="radio" id="facility_type_pharmacy" name="facility_type" value="Pharmacy"  wire:model="facility_type">
                        ...
                        <div class="row_entry">
                            <div>
                                ...
                                <input type="text" name="other_facility_type" id="other_facility_type"  wire:model="other_facility_type">
                ...
                <div class="step-two">
                    ...
                    <div class="row_entry">
                        <div>
                            ...
                            <input type="text"  name="physician_name" id="physician_name"  wire:model="physician_name">
                            <span class="text-danger">@error('physician_name'){{ $message }}@enderror</span>
                        </div> 
                        <div>
                            <p>Title/Role </p>
                            <input type="radio" id="physician_title_oncologist" name="physician_title" value="Oncologist"  wire:model="physician_title">
                            <label for="physician_title_oncologist">Oncologist</label>&nbsp&nbsp&nbsp
                            <input type="radio" id="physician_title_general_practioner" name="physician_title" value="General Practioner"  wire:model="physician_title">
                            <label for="physician_title_general_practioner">General Practioner</label>
                            <input type="radio" id="physician_title_pharmacist" name="physician_title" value="Pharmacist"  wire:model="physician_title">
                    ...
                    <div class="row_entry">
                        <div>
                            ...
                            <input type="text"  name="other_physician_title" id="other_physician_title"  wire:model="other_physician_title">
                        ...
                        <div>
                            ...
                            <input type="text" name="physician_license_no" id="physician_license_no"  wire:model="physician_license_no">
                    ...
                    <div class="row_entry">
                        <div>
                            ...
                            <input type="text"  name="physician_phone" id="physician_phone"  wire:model="physician_phone">
                            <span class="text-danger">@error('physician_phone'){{ $message }}@enderror</span>
                        </div> 
                        <div>
                            <label for="physician_email">Physician Email</label><br>
                            <input type="email" name="physician_email" id="physician_email"  wire:model="physician_email">
                    ...
                    <div class="row_entry">
                        <div>
                            ...
                            <input type="number"  name="physician_expr_years" id="physician_expr_years"  wire:model="physician_expr_years">
                ...
                <div class="step-two">
                    ...
                    <div class="row_entry">
                        <div>
                            ...
                            <input type="text"  name="patient_name" id="patient_name"  wire:model="patient_name">
                        ...
                        <div>
                            ...
                            <input type="text"  name="patient_unique_id" id="patient_unique_id"  wire:model="patient_unique_id">
                    ...
                    <div class="row_entry">
                        <div>
                            ...
                            <input type="date"  name="patient_birth_date" id="patient_birth_date"  wire:model="patient_birth_date">
                        ...
                        <div>
                            ...
                            <input type="radio" id="patient_gender1" name="patient_gender" value="Male"  wire:model="patient_gender">
                            <label for="patient_gender1">Male</label>&nbsp&nbsp&nbsp
                            <input type="radio" id="patient_gender2" name="patient_gender" value="Female"  wire:model="patient_gender">
                            <label for="patient_gender2">Female</label>&nbsp&nbsp&nbsp
                            <input type="radio" id="patient_gender3" name="patient_gender" value="Other"  wire:model="patient_gender">
                    ...
                    <div class="row_entry">
                        <div>
                            ...
                            <input type="radio" id="breast_cancer_confirmed_yes" name="breast_cancer_confirmed" value="Yes"  wire:model="breast_cancer_confirmed">
                            <label for="breast_cancer_confirmed_yes">Yes</label>&nbsp&nbsp&nbsp
                            <input type="radio" id="breast_cancer_confirmed_no" name="breast_cancer_confirmed" value="No"  wire:model="breast_cancer_confirmed">
                    ...
                    <div class="row_entry">
                        <div>
                            ...
                            <input type="text"  name="cancer_stage" id="cancer_stage"  wire:model="cancer_stage">
                            <span class="text-danger">@error('cancer_stage'){{ $message }}@enderror</span>
                        </div> 
                        <div>
                            <label for="tumor_burden">Tumor Burden</label><br>
                            <input type="text"  name="tumor_burden" id="tumor_burden"  wire:model="tumor_burden">
                    ...
                    <div class="row_entry">
                        <div>
                            ...
                            <input type="text"  name="biomarkers_initiation" id="biomarkers_initiation"  wire:model="biomarkers_initiation">
                    ...
                    <div class="row_entry">
                        <div>
                            <p>Chemotherapy?</p>
                            <input type="radio" id="chemotherapy_yes" name="chemotherapy" value="Yes"  wire:model="chemotherapy">
                            <label for="chemotherapy_yes">Yes</label>&nbsp&nbsp&nbsp
                            <input type="radio" id="chemotherapy_no" name="chemotherapy" value="No"  wire:model="chemotherapy">
                        ...
                        <div>
                            <p>Chemotherapy Details</p>
                                <textarea name="chemo_details" id="chemo_details" cols="45" rows="2"  
                    ...
                    <div class="row_entry">
                        <div>
                            <p>Surgery?</p>
                            <input type="radio" id="surgery_yes" name="surgery" value="Yes"  wire:model="surgery">
                            <label for="surgery_yes">Yes</label>&nbsp&nbsp&nbsp
                            <input type="radio" id="surgery_no" name="surgery" value="No"  wire:model="surgery">
                            <label for="surgery_no">No</label><br>
                            <span class="text-danger">@error('surgery'){{ $message }}@enderror</span>
                        </div> 
                        <div>
                            <p>Surgery Details</p>
                                <textarea name="surgery_details" id="surgery_details" cols="45" rows="2"  
                    ...
                    <div class="row_entry">
                        <div>
                            ...
                            <input type="radio" id="post_treatment_yes" name="post_treatment" value="Yes"  wire:model="post_treatment">
                            <label for="post_treatment_yes">Yes</label>&nbsp&nbsp&nbsp
                            <input type="radio" id="post_treatment_no" name="post_treatment" value="No"  wire:model="post_treatment">
                        ...
                        <div>
                            <p>Post-Treatment Care Details</p>
                                <textarea name="post_treatment_details" id="post_treatment_details" cols="45" rows="2"  
                    ...
                    <div class="row_entry">
                        <div>
                            ...
                            <input type="text"  name="enhertu_duration" id="enhertu_duration"  wire:model="enhertu_duration">
                    ...
                    <div class="row_entry">
                        <div>
                            ...
                            <input type="text"  name="liver_function" id="liver_function"  wire:model="liver_function">
                            <span class="text-danger">@error('liver_function'){{ $message }}@enderror</span>
                        </div> 
                        <div>
                            <label for="renal_function">Renal Function</label><br>
                            <input type="text"  name="renal_function" id="renal_function"  wire:model="renal_function">
                    ...
                    <div class="row_entry">
                        <div>
                            ...
                            <input type="text"  name="cardiac_function" id="cardiac_function"  wire:model="cardiac_function">
                    ...
                    <div class="row_entry">
                        <div>
                            ...
                            <input type="radio" id="lab_report_attached_yes" name="lab_report_attached" value="Yes"  wire:model="lab_report_attached">
                            <label for="lab_report_attached_yes">Yes</label>&nbsp&nbsp&nbsp
                            <input type="radio" id="lab_report_attached_no" name="lab_report_attached" value="No"  wire:model="lab_report_attached">
                            <label for="lab_report_attached_no">No</label><br>
                            <span class="text-danger">@error('lab_report_attached'){{ $message }}@enderror</span>
                        </div> 
                        <div>
                            <p>Key Findings</p>
                                <textarea name="key_findings_lab" id="key_findings_lab" cols="45" rows="2"  
                    ...
                    <div class="row_entry">
                        <div>
                            ...
                            <input type="file"  name="lab_report_file" id="lab_report_file"  wire:model="lab_report_file">
                    ...
                    <div class="row_entry">
                        <div>
                            ...
                            <input type="radio" id="hr_ct_scan_attached_yes" name="hr_ct_scan_attached" value="Yes"  wire:model="hr_ct_scan_attached">
                            <label for="hr_ct_scan_attached_yes">Yes</label>&nbsp&nbsp&nbsp
                            <input type="radio" id="hr_ct_scan_attached_no" name="hr_ct_scan_attached" value="No"  wire:model="hr_ct_scan_attached">
                            <label for="hr_ct_scan_attached_no">No</label><br>
                            <span class="text-danger">@error('hr_ct_scan_attached'){{ $message }}@enderror</span>
                        </div> 
                        <div>
                            <p>Key Findings</p>
                                <textarea name="key_findings_hr_ct_scan" id="key_findings_hr_ct_scan" cols="45" rows="2"  
                    ...
                    <div class="row_entry">
                        <div>
                            ...
                            <input type="file"  name="hr_ct_scan_file" id="hr_ct_scan_file"  wire:model="hr_ct_scan_file">
                        ...
                        <div>
                            ...
                            <input type="number"  name="price_ct_scan" id="price_ct_scan"  wire:model="price_ct_scan">
                ...
                <div class="step-two">
                    ...
                    <div class="row_entry">
                        <div >
                            ...
                            <input type="text"  name="insuarance_provider" id="insuarance_provider"  wire:model="insuarance_provider">
                        ...
                        <div >
                            ...
                            <input type="text"  name="insuarance_policy_no" id="insuarance_policy_no"  wire:model="insuarance_policy_no">
                    ...
                    <div class="single_item">
                        <div>
                            ...
                            <textarea name="insuarance_cover_details" id="insuarance_cover_details" cols="50" rows="3"  
                    ...
                    <div class="row_entry">
                        <div>
                            ...
                            <input type="radio" id="ct_scan_coverage_full" name="ct_scan_coverage" value="Fully Covered"  wire:model="ct_scan_coverage">
                            <label for="ct_scan_coverage_full">Fully Covered</label>&nbsp&nbsp&nbsp
                            <input type="radio" id="ct_scan_coverage_partial" name="ct_scan_coverage" value="Partially Covered"  wire:model="ct_scan_coverage">
                            <label for="ct_scan_coverage_partial">Partially Covered</label>&nbsp&nbsp&nbsp
                            <input type="radio" id="ct_scan_coverage_no" name="ct_scan_coverage" value="Not Covered"  wire:model="ct_scan_coverage">
                            <label for="ct_scan_coverage_no">Not Covered</label><br><br>
                            <span class="text-danger">@error('ct_scan_coverage'){{ $message }}@enderror</span>
                        </div> 
                        <div>
                            <p>Lab Coverage</p>
                            <input type="radio" id="lab_coverage_full" name="lab_coverage" value="Fully Covered"  wire:model="lab_coverage">
                            <label for="lab_coverage_full">Fully Covered</label>&nbsp&nbsp&nbsp
                            <input type="radio" id="lab_coverage_partial" name="lab_coverage" value="Partially Covered"  wire:model="lab_coverage">
                            <label for="lab_coverage_partial">Partially Covered</label>&nbsp&nbsp&nbsp
                            <input type="radio" id="lab_coverage_no" name="lab_coverage" value="Not Covered"  wire:model="lab_coverage">
                    ...
                    <div class="row_entry">
                        <div >
                            ...
                            <input type="text"  name="cost_of_care_estimate" id="cost_of_care_estimate"  wire:model="cost_of_care_estimate">
                ...
                <div class="step-two">
                    ...
                    <div class="row_entry">
                        <div>
                            ...
                            <input type="radio" id="adverse_drug_reaction_yes" name="adverse_drug_reaction" value="Yes"  wire:model="adverse_drug_reaction">
                            <label for="adverse_drug_reaction_yes">Yes</label>&nbsp&nbsp&nbsp
                            <input type="radio" id="adverse_drug_reaction_no" name="adverse_drug_reaction" value="No"  wire:model="adverse_drug_reaction">
                            <label for="adverse_drug_reaction_no">No</label><br>
                            <span class="text-danger">@error('adverse_drug_reaction'){{ $message }}@enderror</span>
                        </div> 
                        <div>
                            <p>ADR Details</p>
                                <textarea name="adr_details" id="adr_details" cols="45" rows="2"  
                    ...
                    <div class="row_entry">
                        <div>
                            <p>Dropouts</p>
                            <input type="radio" id="dropouts_yes" name="dropouts" value="Yes"  wire:model="dropouts">
                            <label for="dropouts_yes">Yes</label>&nbsp&nbsp&nbsp
                            <input type="radio" id="dropouts_no" name="dropouts" value="No"  wire:model="dropouts">
                        ...
                        <div>
                            ...
                            <select class="dropdown" name="dropout_reason" id="dropout_reason"  wire:model="dropout_reason">
                                <option value="Select">Select</option>
                                <option value="Death">Death</option>
                                <option value="ADR">ADR </option>
                                <option value="Unknown">Unknown</option>
                                <option value="Cost-of-Care">Cost-of-Care</option>
                    ...
                    <div class="single_item">
                        <div >
                            ...
                            <input type="text"  name="other_dropout_reasons" id="other_dropout_reasons"  wire:model="other_dropout_reasons">
                    ...
                    <div class="row_entry">
                        <div>
                            ...
                            <select class="dropdown" name="mental_health" id="mental_health"  wire:model="mental_health">
                                <option value="Select">Select</option>
                        ...
                        <div >
                            ...
                            <input type="text"  name="other_mental_health" id="other_mental_health"  wire:model="other_mental_health">
                    ...
                    <div class="single_item">
                        <div>
                            <p>Comments/Concerns</p>
                                <textarea name="comments_concerns" id="comments_concerns" cols="100" rows="5"  
