                    ...
                    <div class="single_item">
                        <div>
                            <div >
                                ...
                                <textarea name="surgery_1_description" id="surgery_1_description" cols="100" rows="3"  
                    ...
                    <div class="single_item">
                        <div class="surgery_history">
                          ...
                          <div class="surgery__Doctor">
                            ...
                            <input type="text"  name="surgery_1_Doctor" id="surgery_1_Doctor"  wire:model="surgery_1_Doctor">
                          ...
                          <div class="surgery__location">
                            ...
                            <input type="text"  name="surgery_1_location" id="surgery_1_location"  wire:model="surgery_1_location">
                          ...
                          <div class="surgery__year">
                            ...
                            <input type="number"  name="surgery_1_year" id="surgery_1_year"  wire:model="surgery_1_year">
                    ...
                    <div class="single_item">
                        <div>
                            <div >
                                ...
                                <textarea name="surgery_2_description" id="surgery_2_description" cols="100" rows="3"  
                    ...
                    <div class="single_item">
                        <div class="surgery_history">
                          ...
                          <div class="surgery__Doctor">
                            ...
                            <input type="text"  name="surgery_2_Doctor" id="surgery_2_Doctor"  wire:model="surgery_2_Doctor">
                            <span class="text-danger">@error('surgery_2_Doctor'){{ $message }}@enderror</span>
                          </div>
                          <div class="surgery__location">
                            <label for="surgery_2_location">Location</label><br>
                            <input type="text"  name="surgery_2_location" id="surgery_2_location"  wire:model="surgery_2_location">
                            <span class="text-danger">@error('surgery_2_location'){{ $message }}@enderror</span>
                          </div>
                          <div class="surgery__year">
                            <label for="surgery_2_year">Year</label><br>
                            <input type="number"  name="surgery_2_year" id="surgery_2_year"  wire:model="surgery_2_year">
                    ...
                    <div class="single_item">
                        <div>
                            <div >
                                ...
                                <textarea name="surgery_3_description" id="surgery_3_description" cols="100" rows="3"  
                    ...
                    <div class="single_item">
                        <div class="surgery_history">
                          ...
                          <div class="surgery__Doctor">
                            ...
                            <input type="text"  name="surgery_3_Doctor" id="surgery_3_Doctor"  wire:model="surgery_3_Doctor">
                            <span class="text-danger">@error('surgery_3_Doctor'){{ $message }}@enderror</span>
                          </div>
                          <div class="surgery__location">
                            <label for="surgery_3_location">Location</label><br>
                            <input type="text"  name="surgery_3_location" id="surgery_3_location"  wire:model="surgery_3_location">
                            <span class="text-danger">@error('surgery_3_location'){{ $message }}@enderror</span>
                          </div>
                          <div class="surgery__year">
                            <label for="surgery_3_year">Year</label><br>
                            <input type="number"  name="surgery_3_year" id="surgery_3_year"  wire:model="surgery_3_year">
                    ...
                    <div class="single_item">
                        <div>
                            <div >
                                ...
                                <textarea name="surgery_4_description" id="surgery_4_description" cols="100" rows="3"  
                    ...
                    <div class="single_item">
                        <div class="surgery_history">
                          ...
                          <div class="surgery_Doctor">
                            ...
                            <input type="text"  name="surgery_4_Doctor" id="surgery_4_Doctor"  wire:model="surgery_4_Doctor">
                          ...
                          <div class="surgery_location">
                            ...
                            <input type="text"  name="surgery_4_location" id="surgery_4_location"  wire:model="surgery_4_location">
                          ...
                          <div class="surgery_year">
                            ...
                            <input type="number"  name="surgery_4_year" id="surgery_4_year"  wire:model="surgery_4_year">
                    ...
                    <div class="single_item">
                        <div>
                            <div >
                                ...
                                <textarea name="surgery_5_description" id="surgery_5_description" cols="100" rows="3"  
                    ...
                    <div class="single_item">
                        <div class="surgery_history">
                          ...
                          <div class="surgery_Doctor">
                            ...
                            <input type="text"  name="surgery_5_Doctor" id="surgery_5_Doctor"  wire:model="surgery_5_Doctor">
                            <span class="text-danger">@error('surgery_5_Doctor'){{ $message }}@enderror</span>
                          </div>
                          <div class="surgery_location">
                            <label for="surgery_5_location">Location</label><br>
                            <input type="text"  name="surgery_5_location" id="surgery_5_location"  wire:model="surgery_5_location">
                            <span class="text-danger">@error('surgery_5_location'){{ $message }}@enderror</span>
                          </div>
                          <div class="surgery_year">
                            <label for="surgery_5_year">Year</label><br>
                            <input type="number"  name="surgery_5_year" id="surgery_5_year"  wire:model="surgery_5_year">
                ...
                <div class="step-two">
                            ...
                            <div class="med_history">
                                <div>
                                    <div class="med_history_diseases">
                                        ...
                                        <div>
                                            <input type="radio" id="med_hist_anemia_yes" name="med_hist_anemia" value="Yes"  wire:model="med_hist_anemia">
                                            <label for="med_hist_anemia_yes">Yes</label>&nbsp&nbsp&nbsp
                                            <input type="radio" id="med_hist_anemia_no" name="med_hist_anemia" value="No"  wire:model="med_hist_anemia">
                                    ...
                                    <div class="med_history_diseases">
                                        ...
                                        <div>
                                            <input type="radio" id="med_hist_arthritis_yes" name="med_hist_arthritis" value="Yes"  wire:model="med_hist_arthritis">
                                            <label for="med_hist_arthritis_yes">Yes</label>&nbsp&nbsp&nbsp
                                            <input type="radio" id="med_hist_arthritis_no" name="med_hist_arthritis" value="No"  wire:model="med_hist_arthritis">
                                    ...
                                    <div class="med_history_diseases">
                                        ...
                                        <div>
                                            <input type="radio" id="med_hist_asthma_yes" name="med_hist_asthma" value="Yes"  wire:model="med_hist_asthma">
                                            <label for="med_hist_asthma_yes">Yes</label>&nbsp&nbsp&nbsp
                                            <input type="radio" id="med_hist_asthma_no" name="med_hist_asthma" value="No"  wire:model="med_hist_asthma">
                                    ...
                                    <div class="med_history_diseases">
                                        ...
                                        <div>
                                            <input type="radio" id="med_hist_Atrial_fibrillation_yes" name="med_hist_Atrial_fibrillation" value="Yes"  wire:model="med_hist_Atrial_fibrillation">
                                            <label for="med_hist_Atrial_fibrillation_yes">Yes</label>&nbsp&nbsp&nbsp
                                            <input type="radio" id="med_hist_Atrial_fibrillation_no" name="med_hist_Atrial_fibrillation" value="No"  wire:model="med_hist_Atrial_fibrillation">
                                    ...
                                    <div class="med_history_diseases">
                                        ...
                                        <div>
                                            <input type="radio" id="med_hist_bleeding_problems_yes" name="med_hist_bleeding_problems" value="Yes"  wire:model="med_hist_bleeding_problems">
                                            <label for="med_hist_bleeding_problems_yes">Yes</label>&nbsp&nbsp&nbsp
                                            <input type="radio" id="med_hist_bleeding_problems_no" name="med_hist_bleeding_problems" value="No"  wire:model="med_hist_bleeding_problems">
                                    ...
                                    <div class="med_history_diseases">
                                        ...
                                        <div>
                                            <input type="radio" id="med_hist_benign_prostatic_hyperplasia_yes" name="med_hist_benign_prostatic_hyperplasia" value="Yes"  wire:model="med_hist_benign_prostatic_hyperplasia">
                                            <label for="med_hist_benign_prostatic_hyperplasia_yes">Yes</label>&nbsp&nbsp&nbsp
                                            <input type="radio" id="med_hist_benign_prostatic_hyperplasia_no" name="med_hist_benign_prostatic_hyperplasia" value="No"  wire:model="med_hist_benign_prostatic_hyperplasia">
                                    ...
                                    <div class="med_history_diseases">
                                        ...
                                        <div>
                                            <input type="radio" id="med_hist_coronary_artery_disease_yes" name="med_hist_coronary_artery_disease" value="Yes"  wire:model="med_hist_coronary_artery_disease">
                                            <label for="med_hist_coronary_artery_disease_yes">Yes</label>&nbsp&nbsp&nbsp
                                            <input type="radio" id="med_hist_coronary_artery_disease_no" name="med_hist_coronary_artery_disease" value="No"  wire:model="med_hist_coronary_artery_disease">
                                    ...
                                    <div class="med_history_diseases">
                                        ...
                                        <div>
                                            <input type="radio" id="med_hist_cancer _yes" name="med_hist_cancer" value="Yes"  wire:model="med_hist_cancer">
                                            <label for="med_hist_cancer _yes">Yes</label>&nbsp&nbsp&nbsp
                                            <input type="radio" id="med_hist_cancer _no" name="med_hist_cancer" value="No"  wire:model="med_hist_cancer">
                                    ...
                                    <div class="med_history_diseases">
                                        ...
                                        <div>
                                            <input type="radio" id="med_hist_cardiac _yes" name="med_hist_cardiac" value="Yes"  wire:model="med_hist_cardiac">
                                            <label for="med_hist_cardiac _yes">Yes</label>&nbsp&nbsp&nbsp
                                            <input type="radio" id="med_hist_cardiac _no" name="med_hist_cardiac" value="No"  wire:model="med_hist_cardiac">
                                    ...
                                    <div class="med_history_diseases">
                                        ...
                                        <div>
                                            <input type="radio" id="med_hist_celiac _yes" name="med_hist_celiac" value="Yes"  wire:model="med_hist_celiac">
                                            <label for="med_hist_celiac _yes">Yes</label>&nbsp&nbsp&nbsp
                                            <input type="radio" id="med_hist_celiac _no" name="med_hist_celiac" value="No"  wire:model="med_hist_celiac">
                                    ...
                                    <div class="med_history_diseases">
                                        ...
                                        <div>
                                            <input type="radio" id="med_hist_chestPain _yes" name="med_hist_chestPain" value="Yes"  wire:model="med_hist_chestPain">
                                            <label for="med_hist_chestPain _yes">Yes</label>&nbsp&nbsp&nbsp
                                            <input type="radio" id="med_hist_chestPain _no" name="med_hist_chestPain" value="No"  wire:model="med_hist_chestPain">
                                    ...
                                    <div class="med_history_diseases">
                                        ...
                                        <div>
                                            <input type="radio" id="med_hist_heartfailure _yes" name="med_hist_heartfailure" value="Yes"  wire:model="med_hist_heartfailure">
                                            <label for="med_hist_heartfailure _yes">Yes</label>&nbsp&nbsp&nbsp
                                            <input type="radio" id="med_hist_heartfailure _no" name="med_hist_heartfailure" value="No"  wire:model="med_hist_heartfailure">
                                    ...
                                    <div class="med_history_diseases">
                                        ...
                                        <div>
                                            <input type="radio" id="med_hist_fatiguesyndrome _yes" name="med_hist_fatiguesyndrome" value="Yes"  wire:model="med_hist_fatiguesyndrome">
                                            <label for="med_hist_fatiguesyndrome _yes">Yes</label>&nbsp&nbsp&nbsp
                                            <input type="radio" id="med_hist_fatiguesyndrome _no" name="med_hist_fatiguesyndrome" value="No"  wire:model="med_hist_fatiguesyndrome">
                                    ...
                                    <div class="med_history_diseases">
                                        ...
                                        <div>
                                            <input type="radio" id="med_hist_depression _yes" name="med_hist_depression" value="Yes"  wire:model="med_hist_depression">
                                            <label for="med_hist_depression _yes">Yes</label>&nbsp&nbsp&nbsp
                                            <input type="radio" id="med_hist_depression _no" name="med_hist_depression" value="No"  wire:model="med_hist_depression">
                                    ...
                                    <div class="med_history_diseases">
                                        ...
                                        <div>
                                            <input type="radio" id="med_hist_diabetes _yes" name="med_hist_diabetes" value="Yes"  wire:model="med_hist_diabetes">
                                            <label for="med_hist_diabetes _yes">Yes</label>&nbsp&nbsp&nbsp
                                            <input type="radio" id="med_hist_diabetes _no" name="med_hist_diabetes" value="No"  wire:model="med_hist_diabetes">
                                    ...
                                    <div class="med_history_diseases">
                                        ...
                                        <div>
                                            <input type="radio" id="med_hist_drug_alcohol_abuse _yes" name="med_hist_drug_alcohol_abuse" value="Yes"  wire:model="med_hist_drug_alcohol_abuse">
                                            <label for="med_hist_drug_alcohol_abuse _yes">Yes</label>&nbsp&nbsp&nbsp
                                            <input type="radio" id="med_hist_drug_alcohol_abuse _no" name="med_hist_drug_alcohol_abuse" value="No"  wire:model="med_hist_drug_alcohol_abuse">
                                    ...
                                    <div class="med_history_diseases">
                                        ...
                                        <div>
                                            <input type="radio" id="med_hist_erectile_dysfunction_yes" name="med_hist_erectile_dysfunction" value="Yes"  wire:model="med_hist_erectile_dysfunction">
                                            <label for="med_hist_erectile_dysfunction_yes">Yes</label>&nbsp&nbsp&nbsp
                                            <input type="radio" id="med_hist_erectile_dysfunction_no" name="med_hist_erectile_dysfunction" value="No"  wire:model="med_hist_erectile_dysfunction">
                                    ...
                                    <div class="med_history_diseases">
                                        ...
                                        <div>
                                            <input type="radio" id="med_hist_fibromyalgia_yes" name="med_hist_fibromyalgia" value="Yes"  wire:model="med_hist_fibromyalgia">
                                            <label for="med_hist_fibromyalgia_yes">Yes</label>&nbsp&nbsp&nbsp
                                            <input type="radio" id="med_hist_fibromyalgia_no" name="med_hist_fibromyalgia" value="No"  wire:model="med_hist_fibromyalgia">
                                    ...
                                    <div class="med_history_diseases">
                                        ...
                                        <div>
                                            <input type="radio" id="med_hist_gerd_yes" name="med_hist_gerd" value="Yes"  wire:model="med_hist_gerd">
                                            <label for="med_hist_gerd_yes">Yes</label>&nbsp&nbsp&nbsp
                                            <input type="radio" id="med_hist_gerd_no" name="med_hist_gerd" value="No"  wire:model="med_hist_gerd">
                                    ...
                                    <div class="med_history_diseases">
                                        ...
                                        <div>
                                            <input type="radio" id="med_hist_heart_disease_yes" name="med_hist_heart_disease" value="Yes"  wire:model="med_hist_heart_disease">
                                            <label for="med_hist_heart_disease_yes">Yes</label>&nbsp&nbsp&nbsp
                                            <input type="radio" id="med_hist_heart_disease_no" name="med_hist_heart_disease" value="No"  wire:model="med_hist_heart_disease">
                                    ...
                                    <div class="med_history_diseases">
                                        ...
                                        <div>
                                            <input type="radio" id="med_hist_hyperinsulinemia_yes" name="med_hist_hyperinsulinemia" value="Yes"  wire:model="med_hist_hyperinsulinemia">
                                            <label for="med_hist_hyperinsulinemia_yes">Yes</label>&nbsp&nbsp&nbsp
                                            <input type="radio" id="med_hist_hyperinsulinemia_no" name="med_hist_hyperinsulinemia" value="No"  wire:model="med_hist_hyperinsulinemia">
                                    ...
                                    <div class="med_history_diseases">
                                        ...
                                        <div>
                                            <input type="radio" id="med_hist_hyperlipidemia_yes" name="med_hist_hyperlipidemia" value="Yes"  wire:model="med_hist_hyperlipidemia">
                                            <label for="med_hist_hyperlipidemia_yes">Yes</label>&nbsp&nbsp&nbsp
                                            <input type="radio" id="med_hist_hyperlipidemia_no" name="med_hist_hyperlipidemia" value="No"  wire:model="med_hist_hyperlipidemia">
                                ...
                                <div>
                                    <div class="med_history_diseases">
                                        ...
                                        <div>
                                            <input type="radio" id="med_hist_hypertension_yes" name="med_hist_hypertension" value="Yes"  wire:model="med_hist_hypertension">
                                            <label for="med_hist_hypertension_yes">Yes</label>&nbsp&nbsp&nbsp
                                            <input type="radio" id="med_hist_hypertension_no" name="med_hist_hypertension" value="No"  wire:model="med_hist_hypertension">
                                    ...
                                    <div class="med_history_diseases">
                                        ...
                                        <div>
                                            <input type="radio" id="med_hist_male_hypogonadism_yes" name="med_hist_male_hypogonadism" value="Yes"  wire:model="med_hist_male_hypogonadism">
                                            <label for="med_hist_male_hypogonadism_yes">Yes</label>&nbsp&nbsp&nbsp
                                            <input type="radio" id="med_hist_male_hypogonadism_no" name="med_hist_male_hypogonadism" value="No"  wire:model="med_hist_male_hypogonadism">
                                    ...
                                    <div class="med_history_diseases">
                                        ...
                                        <div>
                                            <input type="radio" id="med_hist_hypogonadism_yes" name="med_hist_hypogonadism" value="Yes"  wire:model="med_hist_hypogonadism">
                                            <label for="med_hist_hypogonadism_yes">Yes</label>&nbsp&nbsp&nbsp
                                            <input type="radio" id="med_hist_hypogonadism_no" name="med_hist_hypogonadism" value="No"  wire:model="med_hist_hypogonadism">
                                ...
                                <div class="med_history_diseases">
                                    ...
                                    <div>
                                        <input type="radio" id="med_hist_Infection_problems _yes" name="med_hist_Infection_problems" value="Yes"  wire:model="med_hist_Infection_problems">
                                        <label for="med_hist_Infection_problems _yes">Yes</label>&nbsp&nbsp&nbsp
                                        <input type="radio" id="med_hist_Infection_problems _no" name="med_hist_Infection_problems" value="No"  wire:model="med_hist_Infection_problems">
                                ...
                                <div class="med_history_diseases">
                                    ...
                                    <div>
                                        <input type="radio" id="med_hist_insomnia _yes" name="med_hist_insomnia" value="Yes"  wire:model="med_hist_insomnia">
                                        <label for="med_hist_insomnia _yes">Yes</label>&nbsp&nbsp&nbsp
                                        <input type="radio" id="med_hist_insomnia _no" name="med_hist_insomnia" value="No"  wire:model="med_hist_insomnia">
                                ...
                                <div class="med_history_diseases">
                                    ...
                                    <div>
                                        <input type="radio" id="med_hist_irritable_bowel_syndrome _yes" name="med_hist_irritable_bowel_syndrome" value="Yes"  wire:model="med_hist_irritable_bowel_syndrome">
                                        <label for="med_hist_irritable_bowel_syndrome _yes">Yes</label>&nbsp&nbsp&nbsp
                                        <input type="radio" id="med_hist_irritable_bowel_syndrome _no" name="med_hist_irritable_bowel_syndrome" value="No"  wire:model="med_hist_irritable_bowel_syndrome">
                                ...
                                <div class="med_history_diseases">
                                    ...
                                    <div>
                                        <input type="radio" id="med_hist_kidney_problems_yes" name="med_hist_kidney_problems " value="Yes"  wire:model="med_hist_kidney_problems ">
                                        <label for="med_hist_kidney_problems_yes">Yes</label>&nbsp&nbsp&nbsp
                                        <input type="radio" id="med_hist_kidney_problems_no" name="med_hist_kidney_problems " value="No"  wire:model="med_hist_kidney_problems ">
                                ...
                                <div class="med_history_diseases">
                                    ...
                                    <div>
                                        <input type="radio" id="med_hist_menopause_yes" name="med_hist_menopause" value="Yes"  wire:model="med_hist_menopause">
                                        <label for="med_hist_menopause_yes">Yes</label>&nbsp&nbsp&nbsp
                                        <input type="radio" id="med_hist_menopause_no" name="med_hist_menopause" value="No"  wire:model="med_hist_menopause">
                                ...
                                <div class="med_history_diseases">
                                    ...
                                    <div>
                                        <input type="radio" id="med_hist_migranes_headaches_yes" name="med_hist_migranes_headaches" value="Yes"  wire:model="med_hist_migranes_headaches">
                                        <label for="med_hist_migranes_headaches_yes">Yes</label>&nbsp&nbsp&nbsp
                                        <input type="radio" id="med_hist_migranes_headaches_no" name="med_hist_migranes_headaches" value="No"  wire:model="med_hist_migranes_headaches">
                                ...
                                <div class="med_history_diseases">
                                    ...
                                    <div>
                                        <input type="radio" id="med_hist_neuropathy_yes" name="med_hist_neuropathy" value="Yes"  wire:model="med_hist_neuropathy">
                                        <label for="med_hist_neuropathy_yes">Yes</label>&nbsp&nbsp&nbsp
                                        <input type="radio" id="med_hist_neuropathy_no" name="med_hist_neuropathy" value="No"  wire:model="med_hist_neuropathy">
                                ...
                                <div class="med_history_diseases">
                                    ...
                                    <div>
                                        <input type="radio" id="med_hist_onychomycosis_yes" name="med_hist_onychomycosis" value="Yes"  wire:model="med_hist_onychomycosis">
                                        <label for="med_hist_onychomycosis_yes">Yes</label>&nbsp&nbsp&nbsp
                                        <input type="radio" id="med_hist_onychomycosis_no" name="med_hist_onychomycosis" value="No"  wire:model="med_hist_onychomycosis">
                                ...
                                <div class="med_history_diseases">
                                    ...
                                    <div>
                                        <input type="radio" id="med_hist_organ_injury_yes" name="med_hist_organ_injury" value="Yes"  wire:model="med_hist_organ_injury">
                                        <label for="med_hist_organ_injury_yes">Yes</label>&nbsp&nbsp&nbsp
                                        <input type="radio" id="med_hist_organ_injury_no" name="med_hist_organ_injury" value="No"  wire:model="med_hist_organ_injury">
                                ...
                                <div class="med_history_diseases">
                                    ...
                                    <div>
                                        <input type="radio" id="med_hist_osteoporosis_yes" name="med_hist_osteoporosis" value="Yes"  wire:model="med_hist_osteoporosis">
                                        <label for="med_hist_osteoporosis_yes">Yes</label>&nbsp&nbsp&nbsp
                                        <input type="radio" id="med_hist_osteoporosis_no" name="med_hist_osteoporosis" value="No"  wire:model="med_hist_osteoporosis">
                                ...
                                <div class="med_history_diseases">
                                    ...
                                    <div>
                                        <input type="radio" id="med_hist_pulmonary_embolism_yes" name="med_hist_pulmonary_embolism" value="Yes"  wire:model="med_hist_pulmonary_embolism">
                                        <label for="med_hist_pulmonary_embolism_yes">Yes</label>&nbsp&nbsp&nbsp
                                        <input type="radio" id="med_hist_pulmonary_embolism_no" name="med_hist_pulmonary_embolism" value="No"  wire:model="med_hist_pulmonary_embolism">
                                ...
                                <div class="med_history_diseases">
                                    ...
                                    <div>
                                        <input type="radio" id="med_hist_seizure_disorders_yes" name="med_hist_seizure_disorders" value="Yes"  wire:model="med_hist_seizure_disorders">
                                        <label for="med_hist_seizure_disorders_yes">Yes</label>&nbsp&nbsp&nbsp
                                        <input type="radio" id="med_hist_seizure_disorders_no" name="med_hist_seizure_disorders" value="No"  wire:model="med_hist_seizure_disorders">
                                ...
                                <div class="med_history_diseases">
                                    ...
                                    <div>
                                        <input type="radio" id="med_hist_short_Breath_yes" name="med_hist_short_Breath" value="Yes"  wire:model="med_hist_short_Breath">
                                        <label for="med_hist_short_Breath_yes">Yes</label>&nbsp&nbsp&nbsp
                                        <input type="radio" id="med_hist_short_Breath_no" name="med_hist_short_Breath" value="No"  wire:model="med_hist_short_Breath">
                                ...
                                <div class="med_history_diseases">
                                    ...
                                    <div>
                                        <input type="radio" id="med_hist_sinus_onditions_yes" name="med_hist_sinus_onditions" value="Yes"  wire:model="med_hist_sinus_onditions">
                                        <label for="med_hist_sinus_onditions_yes">Yes</label>&nbsp&nbsp&nbsp
                                        <input type="radio" id="med_hist_sinus_onditions_no" name="med_hist_sinus_onditions" value="No"  wire:model="med_hist_sinus_onditions">
                                ...
                                <div class="med_history_diseases">
                                    ...
                                    <div>
                                        <input type="radio" id="med_hist_stroke_yes" name="med_hist_stroke" value="Yes"  wire:model="med_hist_stroke">
                                        <label for="med_hist_stroke_yes">Yes</label>&nbsp&nbsp&nbsp
                                        <input type="radio" id="med_hist_stroke_no" name="med_hist_stroke" value="No"  wire:model="med_hist_stroke">
                                ...
                                <div class="med_history_diseases">
                                    ...
                                    <div>
                                        <input type="radio" id="med_hist_syndrome_x_yes" name="med_hist_syndrome_x" value="Yes"  wire:model="med_hist_syndrome_x">
                                        <label for="med_hist_syndrome_x_yes">Yes</label>&nbsp&nbsp&nbsp
                                        <input type="radio" id="med_hist_syndrome_x_no" name="med_hist_syndrome_x" value="No"  wire:model="med_hist_syndrome_x">
                                ...
                                <div class="med_history_diseases">
                                    ...
                                    <div>
                                        <input type="radio" id="med_hist_tremors_yes" name="med_hist_tremors" value="Yes"  wire:model="med_hist_tremors">
                                        <label for="med_hist_tremors_yes">Yes</label>&nbsp&nbsp&nbsp
                                        <input type="radio" id="med_hist_tremors_no" name="med_hist_tremors" value="No"  wire:model="med_hist_tremors">
                                ...
                                <div class="med_history_diseases">
                                    ...
                                    <div>
                                        <input type="radio" id="med_hist_wheat_allergy_yes" name="med_hist_wheat_allergy" value="Yes"  wire:model="med_hist_wheat_allergy">
                                        <label for="med_hist_wheat_allergy_yes">Yes</label>&nbsp&nbsp&nbsp
                                        <input type="radio" id="med_hist_wheat_allergy_no" name="med_hist_wheat_allergy" value="No"  wire:model="med_hist_wheat_allergy">
                    ...
                    <div class="single_item">
                        <div>
                            ...
                            <input type="text"  name="any_other_medical_problem" id="any_other_medical_problem"  wire:model="any_other_medical_problem">
