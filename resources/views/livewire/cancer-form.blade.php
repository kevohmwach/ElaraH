<div>
    <form  wire:submit.prevent="{{$method}}">
        ...
        <div class="form_wrapper">
            @if ($currentStep == 1)
                <div class="step-one">
                    <div class="steps  bg-secondary text-white">STEP 1/5</div>
                    ...
                    <div class="personal_info">
                        ...
                        {{-- <div class="row_entry">
                            <div>
                                ...
                                <input type="text" name="patient_initials" id="patient_initials" wire:model="patient_initials" >
                            ...
                            <div>
                                ...
                                <input type="text" name="Interviewer_Initials" id="Interviewer_Initials"  wire:model="Interviewer_Initials">
                        ...
                        <div class="single_item">
                            <div>
                                ...
                                <input type="text" name="current_diagnosis" id="current_diagnosis"  wire:model="current_diagnosis">
                        ...
                        <div class="row_entry">
                            <div>
                                ...
                                <input type="date" name="diagnosis_date" id="diagnosis_date"  wire:model="diagnosis_date">
                        ...
                        <div class="row_entry">
                            <div>
                                ...
                                <input type="radio" id="surgery_yes" name="had_surgery" value="Yes"  wire:model="had_surgery">
                                <label for="surgery_yes">Yes</label>&nbsp&nbsp&nbsp
                                <input type="radio" id="surgery_no" name="had_surgery" value="No"  wire:model="had_surgery">
                            ...
                            <div>
                                ...
                                <input type="date" name="surgery_date" id="surgery_date"  wire:model="surgery_date">
                        ...
                        <div class="row_entry">
                            <div>
                                ...
                                <input type="text" name="surgeon_name" id="surgeon_name"  wire:model="surgeon_name">
                                <span class="text-danger">@error('surgeon_name'){{ $message }}@enderror</span>
                            </div>
                            <div>
                                <label for="surgeon_phone">Surgeon’s Phone no.</label><br>
                                <input type="text" name="surgeon_phone" id="surgeon_phone"  wire:model="surgeon_phone">
                        ...
                        <div class="single_item">
                            <div>
                                ...
                                <input type="text" name="what_surgery" id="what_surgery"  wire:model="what_surgery">
                        ...
                        <div class="row_entry">
                            <div>
                                ...
                                <input type="radio" id="surgery_recovered_yes" name="surgery_recovered" value="Yes"  wire:model="surgery_recovered">
                                <label for="surgery_recovered_yes">Yes</label>&nbsp&nbsp&nbsp
                                <input type="radio" id="surgery_recovered_no" name="surgery_recovered" value="No"  wire:model="surgery_recovered">
                            ...
                            <div>
                                ...
                                <input type="radio" id="surgery_complication_yes" name="surgery_complication" value="Yes"  wire:model="surgery_complication">
                                <label for="surgery_complication_yes">Yes</label>&nbsp&nbsp&nbsp
                                <input type="radio" id="surgery_complication_no" name="surgery_complication" value="No"  wire:model="surgery_complication">
                        ...
                        <div class="single_item">
                            <div>
                                ...
                                <textarea name="surgery_complication_explain" id="surgery_complication_explain" cols="100" rows="5"  
                        ...
                        <div class="row_entry">
                            <div>
                                ...
                                <input type="radio" id="had_radiation_yes" name="had_radiation" value="Yes"  wire:model="had_radiation">
                                <label for="had_radiation_yes">Yes</label>&nbsp&nbsp&nbsp
                                <input type="radio" id="had_radiation_no" name="had_radiation" value="No"  wire:model="had_radiation">
                            ...
                            <div>
                                ...
                                <input type="date"  name="radiation_date" id="radiation_date"  wire:model="radiation_date">
                        ...
                        <div class="row_entry">
                            <div>
                                ...
                                <input type="text"  name="radiologist_name" id="radiologist_name"  wire:model="radiologist_name">
                            ...
                            <div>
                                ...
                                <input type="text" name="radiologist_phone" id="radiologist_phone"  wire:model="radiologist_phone">
                        ...
                        <div class="single_item">
                            <div>
                                ...
                                <textarea name="radiation_treatment" id="radiation_treatment" cols="100" rows="3"  
                        ...
                        <div class="row_entry">
                            <div>
                                ...
                                <input type="radio" id="radiation_recovered_yes" name="radiation_recovered" value="Yes"  wire:model="radiation_recovered">
                                <label for="radiation_recovered_yes">Yes</label>&nbsp&nbsp&nbsp
                                <input type="radio" id="radiation_recovered_no" name="radiation_recovered" value="No"  wire:model="radiation_recovered">
                            ...
                            <div>
                                ...
                                <input type="radio" id="radiation_complications_yes" name="radiation_complications" value="Yes"  wire:model="radiation_complications">
                                <label for="radiation_complications_yes">Yes</label>&nbsp&nbsp&nbsp
                                <input type="radio" id="radiation_complications_no" name="radiation_complications" value="No"  wire:model="radiation_complications">
                        ...
                        <div class="single_item">
                            <div>
                                ...
                                <textarea name="radiation_complication_explain" id="radiation_complication_explain" cols="100" rows="4"  
            ...
            @if ($currentStep == 2)
                <div class="step-two">
                    <div class="steps bg-secondary text-white">STEP 2/5</div>
                    <h4 class="sectionTitle" >TREATING PHYSICIANS</h4>
                
                    <div class="row_entry">
                        <div>
                            <label for="primary_physician_name">Primary Care Physician Name</label><br>
                            <input type="text"  name="primary_physician_name" id="primary_physician_name"  wire:model="primary_physician_name">
                        ...
                        <div>
                            ...
                            <input type="text"  name="primary_physician_contact" id="primary_physician_contact"  wire:model="primary_physician_contact">
                    ...
                    <div class="row_entry">
                        <div>
                            ...
                            <input type="text"  name="oncologist_name" id="oncologist_name"  wire:model="oncologist_name">
                            <span class="text-danger">@error('oncologist_name'){{ $message }}@enderror</span>
                        </div> 
                        <div>
                            <label for="oncologist_phone">Oncologist Contact </label><br>
                            <input type="text"  name="oncologist_phone" id="oncologist_phone"  wire:model="oncologist_phone">
                    ...
                    <div class="row_entry">
                        <div>
                            ...
                            <input type="text"  name="physician_1_name" id="physician_1_name"  wire:model="physician_1_name">
                        ...
                        <div>
                            ...
                            <input type="text"  name="physician_1_speciality" id="physician_1_speciality"  wire:model="physician_1_speciality">
                    ...
                    <div class="row_entry">
                        <div>
                            ...
                            <input type="text"  name="physician_2_name" id="physician_2_name"  wire:model="physician_2_name">
                        ...
                        <div>
                            ...
                            <input type="text"  name="physician_2_speciality" id="physician_2_speciality"  wire:model="physician_2_speciality">
                    ...
                    <div class="row_entry">
                        <div>
                            ...
                            <input type="text"  name="physician_3_name" id="physician_3_name"  wire:model="physician_3_name">
                        ...
                        <div>
                            ...
                            <input type="text"  name="physician_3_speciality" id="physician_3_speciality"  wire:model="physician_3_speciality">
                    ...
                    <div class="row_entry">
                        <div>
                            ...
                            <input type="text"  name="physician_4_name" id="physician_4_name"  wire:model="physician_4_name">
                        ...
                        <div>
                            ...
                            <input type="text"  name="physician_4_speciality" id="physician_4_speciality"  wire:model="physician_4_speciality">
            ...
            @if ($currentStep == 3)
                <div class="step-two">
                    <div class="steps bg-secondary text-white">STEP 3/5</div>
                    ...
                    <div class="row_entry">
                        <div>
                            ...
                            <input type="text"  name="allergy_1" id="allergy_1"  wire:model="allergy_1">
                            <span class="text-danger">@error('allergy_1'){{ $message }}@enderror</span>
                        </div> 
                        <div>
                            <label for="allergy_1_reaction">Allergy 1 Reaction </label><br>
                            <input type="text"  name="allergy_1_reaction" id="allergy_1_reaction"  wire:model="allergy_1_reaction">
                    ...
                    <div class="row_entry">
                        <div>
                            ...
                            <input type="text"  name="allergy_2" id="allergy_2"  wire:model="allergy_2">
                            <span class="text-danger">@error('allergy_2'){{ $message }}@enderror</span>
                        </div> 
                        <div>
                            <label for="allergy_2_reaction">Allergy 2 Reaction </label><br>
                            <input type="text"  name="allergy_2_reaction" id="allergy_2_reaction"  wire:model="allergy_2_reaction">
                    ...
                    <div class="row_entry">
                        <div>
                            ...
                            <input type="text"  name="allergy_3" id="allergy_3"  wire:model="allergy_3">
                            <span class="text-danger">@error('allergy_3'){{ $message }}@enderror</span>
                        </div> 
                        <div>
                            <label for="allergy_3_reaction">Allergy 3 Reaction </label><br>
                            <input type="text"  name="allergy_3_reaction" id="allergy_3_reaction"  wire:model="allergy_3_reaction">
                    ...
                    <div class="row_entry">
                        <div>
                            ...
                            <input type="text"  name="allergy_4" id="allergy_4"  wire:model="allergy_4">
                            <span class="text-danger">@error('allergy_4'){{ $message }}@enderror</span>
                        </div> 
                        <div>
                            <label for="allergy_4_reaction">Allergy 4 Reaction </label><br>
                            <input type="text"  name="allergy_4_reaction" id="allergy_4_reaction"  wire:model="allergy_4_reaction">
                ...
                <div class="step-two">
                    ...
                    <div class="row_entry">
                        <div>
                            ...
                            <input type="text"  name="dose_n_sig_1" id="dose_n_sig_1"  wire:model="dose_n_sig_1">
                        ...
                        <div>
                            ...
                            <input type="text"  name="dose_n_sig_1_medication" id="dose_n_sig_1_medication"  wire:model="dose_n_sig_1_medication">
                    ...
                    <div class="row_entry">
                        <div>
                            ...
                            <input type="text"  name="dose_n_sig_2" id="dose_n_sig_2"  wire:model="dose_n_sig_2">
                        ...
                        <div>
                            ...
                            <input type="text"  name="dose_n_sig_2_medication" id="dose_n_sig_2_medication"  wire:model="dose_n_sig_2_medication">
                    ...
                    <div class="row_entry">
                        <div>
                            ...
                            <input type="text"  name="dose_n_sig_3" id="dose_n_sig_3"  wire:model="dose_n_sig_3">
                        ...
                        <div>
                            ...
                            <input type="text"  name="dose_n_sig_3_medication" id="dose_n_sig_3_medication"  wire:model="dose_n_sig_3_medication">
                    ...
                    <div class="row_entry">
                        <div>
                            ...
                            <input type="text"  name="dose_n_sig_4" id="dose_n_sig_4"  wire:model="dose_n_sig_4">
                        ...
                        <div>
                            ...
                            <input type="text"  name="dose_n_sig_4_medication" id="dose_n_sig_4_medication"  wire:model="dose_n_sig_4_medication">
            ...
            @if ($currentStep == 5)
                <div class="step-one">
                    <div class="steps  bg-secondary text-white">STEP 5/5</div>
                    ...
                    <div class="personal_info">
                        ...
                        <div class="single_item">
                            <div>
                                ...
                                <input type="text" name="primary_worry" id="primary_worry" wire:model="primary_worry" >
                        ...
                        <div class="single_item">
                            <div>
                                ...
                                <input type="text" name="issue_began" id="issue_began"  wire:model="issue_began">
                        ...
                        <div class="single_item">
                            <div>
                                ...
                                <input type="radio" id="in_pain_yes" name="in_pain" value="Yes"  wire:model="in_pain">
                                <label for="in_pain_yes">Yes</label>&nbsp&nbsp&nbsp
                                <input type="radio" id="in_pain_no" name="in_pain" value="No"  wire:model="in_pain">
                        ...
                        <div class="single_item">
                            <div>
                                ...
                                <textarea name="pain_location" id="pain_location" cols="100" rows="3"  
                        ...
                        <div class="single_item">
                            <div>
                                ...
                                <textarea name="pain_treatment" id="pain_treatment" cols="100" rows="3"  
                        ...
                        <div class="row_entry">
                            <div>
                                ...
                                <input type="radio" id="pain_treatment_increase" name="pain_treatment_change" value="Increased"  wire:model="pain_treatment_change">
                                <label for="pain_treatment_increase">Increased</label>&nbsp&nbsp&nbsp
                                <input type="radio" id="pain_treatment_decrease" name="pain_treatment_change" value="Decreased"  wire:model="pain_treatment_change">
                                <label for="pain_treatment_decrease">Decreased</label>&nbsp&nbsp&nbsp
                                <input type="radio" id="pain_treatment_unchage" name="pain_treatment_change" value="Unchaged"  wire:model="pain_treatment_change">
                            ...
                            <div>
                                ...
                                <input type="radio" id="pain_begin_trend_gradual" name="pain_begin_trend" value="Gradually"  wire:model="pain_begin_trend">
                                <label for="pain_begin_trend_gradual">Gradually</label>&nbsp&nbsp&nbsp
                                <input type="radio" id="pain_begin_trend_sudden" name="pain_begin_trend" value="Suddenly"  wire:model="pain_begin_trend">
                        ...
                        <div class="row_entry">
                            <div>
                                ...
                                <input type="radio" id="pain_occurence_constant" name="pain_occurence" value="Constantly"  wire:model="pain_occurence">
                                <label for="pain_occurence_constant">Constantly</label>&nbsp&nbsp&nbsp
                                <input type="radio" id="pain_occurence_occassional" name="pain_occurence" value="Occasionally"  wire:model="pain_occurence">
                                <label for="pain_occurence_occassional">Occasionally</label>&nbsp&nbsp&nbsp
                                <input type="radio" id="pain_occurence_rarely" name="pain_occurence" value="Rarely"  wire:model="pain_occurence">
                            ...
                            <div>
                                ...
                                <input type="radio" id="pain_worst_morning" name="pain_worst" value="Morning"  wire:model="pain_worst">
                                <label for="pain_worst_morning">Morning</label>&nbsp&nbsp&nbsp
                                <input type="radio" id="pain_worst_afternoon" name="pain_worst" value="Afternoon"  wire:model="pain_worst">
                                <label for="pain_worst_afternoon">Afternoon</label>&nbsp&nbsp&nbsp
                                <input type="radio" id="pain_worst_even" name="pain_worst" value="Evenning"  wire:model="pain_worst">
                                <label for="pain_worst_even">Evenning</label>&nbsp&nbsp&nbsp
                                <input type="radio" id="pain_worst_night" name="Night" value="Night"  wire:model="pain_worst">
                        ...
                        <div class="single_item">
                            <div>
                                ...
                                <textarea name="curr_symptoms" id="curr_symptoms" cols="100" rows="3"  
                        ...
                        <div class="single_item">
                            <div>
                                ...
                                <div class="pain_descr">
                                    <div>
                                        <input type="checkbox" name="aching" id="aching" value="Aching"  wire:model="pain_descr">
                                        <label for="aching"> Aching</label><br>
                                        <input type="checkbox" name="cramping" id="cramping" value="Cramping "  wire:model="pain_descr">
                                        <label for="cramping">Cramping </label><br>
                                        <input type="checkbox" name="dull" id="dull" value="Dull"  wire:model="pain_descr">
                                        <label for="dull"> Dull</label><br>
                                        <input type="checkbox" name="hot" id="hot" value="Burning"  wire:model="pain_descr">
                                        <label for="hot">Hot/Burning </label><br>
                                        {{-- <span class="text-danger">@error('pain_descr'){{ $message }}@enderror</span> --}}
                                    </div>
                                    <div>
                                        <input type="checkbox" name="numbness" id="numbness" value="Numbness"  wire:model="pain_descr">
                                        <label for="numbness"> Numbness</label><br>
                                        <input type="checkbox" name="shock-like " id="shock-like" value="shock-like"  wire:model="pain_descr">
                                        <label for="shock-like ">Shock-like  </label><br>
                                        <input type="checkbox" name="shooting " id="shooting" value="shooting "  wire:model="pain_descr">
                                        <label for="shooting ">Shooting </label><br>
                                        {{-- <span class="text-danger">@error('pain_descr'){{ $message }}@enderror</span> --}}
                                    </div>
                                    <div>
                                        <input type="checkbox" name="spasming " id="spasming" value="spasming"  wire:model="pain_descr">
                                        <label for="spasming "> Spasming </label><br>
                                        <input type="checkbox" name="squeezing  " id="squeezing" value="squeezing"  wire:model="pain_descr">
                                        <label for="squeezing  ">Squeezing   </label><br>
                                        <input type="checkbox" name="sharp  " id="sharp  " value="sharp"  wire:model="pain_descr">
                                        <label for="sharp  ">Stabbing/Sharp</label><br>
                                        {{-- <span class="text-danger">@error('pain_descr'){{ $message }}@enderror</span> --}}
                                    </div>
                                    <div>
                                        <input type="checkbox" name="throbbing " id="throbbing " value="Throbbing "  wire:model="pain_descr">
                                        <label for="throbbing "> Throbbing </label><br>
                                        <input type="checkbox" name="tingling" id="tingling" value="Tingling "  wire:model="pain_descr">
                                        <label for="tingling">Tingling </label><br>
                                        <input type="checkbox" name="tiring/exhausting" id="tiring/exhausting" value="Tiring/Exhausting"  wire:model="pain_descr">
                        ...
                        <div class="single_item">
                            <div>
                                ...
                                <textarea name="other_health_concerns" id="other_health_concerns" cols="100" rows="3"  
