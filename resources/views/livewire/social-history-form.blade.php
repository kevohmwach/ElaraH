                    ...
                    <div class="personal_info">
                        ...
                        <div class="row_entry">
                            <div>
                                ...
                                <input type="text" name="condition_mother" id="condition_mother" wire:model="condition_mother" >
                                <span class="text-danger">@error('condition_mother'){{ $message }}@enderror</span>
                            </div>
                            <div>
                                <p>Living?</p>
                                <input type="radio" id="mother_alive_yes" name="mother_alive" value="Yes"  wire:model="mother_alive">
                                <label for="mother_alive_yes">Yes</label>&nbsp&nbsp&nbsp
                                <input type="radio" id="mother_alive_no" name="mother_alive" value="No"  wire:model="mother_alive">
                        ...
                        <div class="single_item">
                            <div>
                                ...
                                <input type="number" name="mother_deceased_age" id="mother_deceased_age"  wire:model="mother_deceased_age">
                        ...
                        <div class="row_entry">
                            <div>
                                ...
                                <input type="text" name="condition_father" id="condition_father" wire:model="condition_father" >
                                <span class="text-danger">@error('condition_father'){{ $message }}@enderror</span>
                            </div>
                            <div>
                                <p>Living?</p>
                                <input type="radio" id="father_alive_yes" name="father_alive" value="Yes"  wire:model="father_alive">
                                <label for="father_alive_yes">Yes</label>&nbsp&nbsp&nbsp
                                <input type="radio" id="father_alive_no" name="father_alive" value="No"  wire:model="father_alive">
                        ...
                        <div class="single_item">
                            <div>
                                ...
                                <input type="number" name="father_deceased_age" id="father_deceased_age"  wire:model="father_deceased_age">
                        ...
                        <div class="row_entry">
                            <div>
                                ...
                                <input type="text" name="condition_sibling_1" id="condition_sibling_1" wire:model="condition_sibling_1" >
                                <span class="text-danger">@error('condition_sibling_1'){{ $message }}@enderror</span>
                            </div>
                            <div>
                                <p>Living?</p>
                                <input type="radio" id="sibling_1_alive_yes" name="sibling_1_alive" value="Yes"  wire:model="sibling_1_alive">
                                <label for="sibling_1_alive_yes">Yes</label>&nbsp&nbsp&nbsp
                                <input type="radio" id="sibling_1_alive_no" name="sibling_1_alive" value="No"  wire:model="sibling_1_alive">
                        ...
                        <div class="single_item">
                            <div>
                                ...
                                <input type="number" name="sibling_1_deceased_age" id="sibling_1_deceased_age"  wire:model="sibling_1_deceased_age">
                        ...
                        <div class="row_entry">
                            <div>
                                ...
                                <input type="text" name="condition_sibling_2" id="condition_sibling_2" wire:model="condition_sibling_2" >
                                <span class="text-danger">@error('condition_sibling_2'){{ $message }}@enderror</span>
                            </div>
                            <div>
                                <p>Living?</p>
                                <input type="radio" id="sibling_2_alive_yes" name="sibling_2_alive" value="Yes"  wire:model="sibling_2_alive">
                                <label for="sibling_2_alive_yes">Yes</label>&nbsp&nbsp&nbsp
                                <input type="radio" id="sibling_2_alive_no" name="sibling_2_alive" value="No"  wire:model="sibling_2_alive">
                        ...
                        <div class="single_item">
                            <div>
                                ...
                                <input type="number" name="sibling_2_deceased_age" id="sibling_2_deceased_age"  wire:model="sibling_2_deceased_age">
                        ...
                        <div class="row_entry">
                            <div>
                                ...
                                <input type="text" name="condition_others_1" id="condition_others_1" wire:model="condition_others_1" >
                                <span class="text-danger">@error('condition_others_1'){{ $message }}@enderror</span>
                            </div>
                            <div>
                                <p>Living?</p>
                                <input type="radio" id="others_1_alive_yes" name="others_1_alive" value="Yes"  wire:model="others_1_alive">
                                <label for="others_1_alive_yes">Yes</label>&nbsp&nbsp&nbsp
                                <input type="radio" id="others_1_alive_no" name="others_1_alive" value="No"  wire:model="others_1_alive">
                        ...
                        <div class="single_item">
                            <div>
                                ...
                                <input type="number" name="others_1_deceased_age" id="others_1_deceased_age"  wire:model="others_1_deceased_age">
                        ...
                        <div class="row_entry">
                            <div>
                                ...
                                <input type="text" name="condition_others_2" id="condition_others_2" wire:model="condition_others_2" >
                                <span class="text-danger">@error('condition_others_2'){{ $message }}@enderror</span>
                            </div>
                            <div>
                                <p>Living?</p>
                                <input type="radio" id="others_2_alive_yes" name="others_2_alive" value="Yes"  wire:model="others_2_alive">
                                <label for="others_2_alive_yes">Yes</label>&nbsp&nbsp&nbsp
                                <input type="radio" id="others_2_alive_no" name="others_2_alive" value="No"  wire:model="others_2_alive">
                        ...
                        <div class="single_item">
                            <div>
                                ...
                                <input type="number" name="others_2_deceased_age" id="others_2_deceased_age"  wire:model="others_2_deceased_age">
                ...
                <div class="step-two">
                    ...
                    <div class="row_entry">
                        <div>
                            ...
                            <input type="radio" id="consume_alcohol_yes" name="consume_alcohol" value="Yes"  wire:model="consume_alcohol">
                            <label for="consume_alcohol_yes">Yes</label>&nbsp&nbsp&nbsp
                            <input type="radio" id="consume_alcohol_no" name="consume_alcohol" value="No"  wire:model="consume_alcohol">
                        ...
                        <div>
                            ...
                            <input type="number"  name="drinks_per_week" id="drinks_per_week"  wire:model="drinks_per_week">
                    ...
                    <div class="row_entry">
                        <div>
                            ...
                            <input type="radio" id="currently_smoke_yes" name="currently_smoke" value="Yes"  wire:model="currently_smoke">
                            <label for="currently_smoke_yes">Yes</label>&nbsp&nbsp&nbsp
                            <input type="radio" id="currently_smoke_no" name="currently_smoke" value="No"  wire:model="currently_smoke">
                        ...
                        <div>
                            ...
                            <input type="number"  name="cigarettes_per_day" id="cigarettes_per_day"  wire:model="cigarettes_per_day">
                    ...
                    <div class="row_entry">
                        <div>
                            ...
                            <input type="radio" id="use_any_other_drug_yes" name="use_any_other_drug" value="Yes"  wire:model="use_any_other_drug">
                            <label for="use_any_other_drug_yes">Yes</label>&nbsp&nbsp&nbsp
                            <input type="radio" id="use_any_other_drug_no" name="use_any_other_drug" value="No"  wire:model="use_any_other_drug">
                        ...
                        <div>
                            ...
                            <input type="text"  name="any_other_drug" id="any_other_drug"  wire:model="any_other_drug">
                    ...
                    <div class="single_item">
                        <div>
                            ...
                            <input type="radio" id="any_other_drug_frequency_daily" name="any_other_drug_frequency" value="Daily"  wire:model="any_other_drug_frequency">
                            <label for="any_other_drug_frequency_daily ">Daily </label>&nbsp&nbsp&nbsp
                             <input type="radio" id="any_other_drug_frequency_weekly" name="any_other_drug_frequency" value="Weekly"  wire:model="any_other_drug_frequency">
                            <label for="any_other_drug_frequency_weekly">Weekly</label>&nbsp&nbsp&nbsp
                             <input type="radio" id="any_other_drug_frequency_occasionally" name="any_other_drug_frequency" value="Occasionally"  wire:model="any_other_drug_frequency">
                            <label for="any_other_drug_frequency_occasionally">Occasionally</label>&nbsp&nbsp&nbsp
                            <input type="radio" id="any_other_drug_frequency_rarely" name="any_other_drug_frequency" value="Rarely "  wire:model="any_other_drug_frequency">
                    ...
                    <div class="row_entry">
                        <div>
                            ...
                            <input type="radio" id="drink_caffein_yes" name="drink_caffein" value="Yes"  wire:model="drink_caffein">
                            <label for="drink_caffein_yes">Yes</label>&nbsp&nbsp&nbsp
                            <input type="radio" id="drink_caffein_no" name="drink_caffein" value="No"  wire:model="drink_caffein">
                        ...
                        <div>
                            ...
                            <input type="number"  name="caffein_cups_per_day" id="caffein_cups_per_day"  wire:model="caffein_cups_per_day">
                    ...
                    <div class="row_entry">
                        <div>
                            ...
                            <input type="radio" id="sexually_active_yes" name="sexually_active" value="Yes"  wire:model="sexually_active">
                            <label for="sexually_active_yes">Yes</label>&nbsp&nbsp&nbsp
                            <input type="radio" id="sexually_active_no" name="sexually_active" value="No"  wire:model="sexually_active">
                        ...
                        <div>
                            ...
                            <input type="radio" id="like_checked_stis_yes" name="like_checked_stis" value="Yes"  wire:model="like_checked_stis">
                            <label for="like_checked_stis_yes">Yes</label>&nbsp&nbsp&nbsp
                            <input type="radio" id="like_checked_stis_no" name="like_checked_stis" value="No"  wire:model="like_checked_stis">
                        ...
                        <div>
                            ...
                            <input type="radio" id="excercise_frequency_daily" name="excercise_frequency" value="Daily"  wire:model="excercise_frequency">
                            <label for="excercise_frequency_daily ">Daily </label>&nbsp&nbsp&nbsp
                             <input type="radio" id="excercise_frequency_weekly" name="excercise_frequency" value="Weekly"  wire:model="excercise_frequency">
                            <label for="excercise_frequency_weekly">Weekly</label>&nbsp&nbsp&nbsp
                             <input type="radio" id="excercise_frequency_occasionally" name="excercise_frequency" value="Occasionally"  wire:model="excercise_frequency">
                            <label for="excercise_frequency_occasionally">Occasionally</label>&nbsp&nbsp&nbsp
                            <input type="radio" id="excercise_frequency_rarely" name="excercise_frequency" value="Rarely "  wire:model="excercise_frequency">
                    ...
                    <div class="row_entry">
                        <div>
                            ...
                            <input type="radio" id="on_special_diet_yes" name="on_special_diet" value="Yes"  wire:model="on_special_diet">
                            <label for="on_special_diet_yes">Yes</label>&nbsp&nbsp&nbsp
                            <input type="radio" id="on_special_diet_no" name="on_special_diet" value="No"  wire:model="on_special_diet">
                        ...
                        <div>
                            ...
                            <input type="text"  name="special_diet_type" id="special_diet_type"  wire:model="special_diet_type">
                    ...
                    <div class="row_entry">
                        <div>
                            ...
                            <input type="radio" id="pregnancy_plan_yes" name="pregnancy_plan" value="Yes"  wire:model="pregnancy_plan">
                            <label for="pregnancy_plan_yes">Yes</label>&nbsp&nbsp&nbsp
                            <input type="radio" id="pregnancy_plan_no" name="pregnancy_plan" value="No"  wire:model="pregnancy_plan">
                        ...
                        <div>
                            ...
                            <input type="radio" id="pregnant_now_yes" name="pregnant_now" value="Yes"  wire:model="pregnant_now">
                            <label for="pregnant_now_yes">Yes</label>&nbsp&nbsp&nbsp
                            <input type="radio" id="pregnant_now_no" name="pregnant_now" value="No"  wire:model="pregnant_now">
                    ...
                    <div class="row_entry">
                        <div>
                            ...
                            <input type="text"  name="contraception_in_use" id="contraception_in_use"  wire:model="contraception_in_use">
                        ...
                        <div>
                            ...
                            <input type="date"  name="last_menstrual_cycle" id="last_menstrual_cycle"  wire:model="last_menstrual_cycle">
